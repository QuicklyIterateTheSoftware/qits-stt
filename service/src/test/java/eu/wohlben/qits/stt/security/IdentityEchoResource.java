 ...
 *
 * <p>Served under {@code /stt/api/test-identity} — the suite inherits the shipped {@code
 * quarkus.rest.path=/stt/api}, so the fixture is addressed exactly as a real route is.
 *
